...
Auto updating Twitter feed. (based on [Webpack 4 React Starter](https://github.com/piotrlewandowski/webpack-4-react-starter))
...
1. Clone the repository `git clone git@github.com:piotrlewandowski/auto-updating-twitter-feed.git`
